...
export function AppShell({ children, activePage, onNavigate }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("nav", { className: "navbar navbar-expand-md px-3 px-md-4", style: { backgroundColor: "#006B3C" }, "data-testid": "app-shell-nav", children: [_jsx("button", { className: "navbar-brand fw-bold text-white fs-5 btn p-0 border-0", style: { letterSpacing: "0.02em", background: "none" }, onClick: () => onNavigate?.("my-tickets"), "aria-label": "TokTickIT home", children: "\uD83D\uDD50 TokTickIT" }), _jsx("button", { className: "navbar-toggler border-0", type: "button", "data-bs-toggle": "collapse", "data-bs-target": "#main-nav", "aria-controls": "main-nav", "aria-expanded": "false", "aria-label": "Toggle navigation", style: { color: "white" }, children: _jsx("span", { className: "navbar-toggler-icon", style: { filter: "invert(1)" } }) }), _jsxs("div", { className: "collapse navbar-collapse", id: "main-nav", children: [_jsx("ul", { className: "navbar-nav me-auto gap-1", children: user?.role === "REQUESTER" && (_jsxs(_Fragment, { children: [_jsx("li", { className: "nav-item", children: _jsx("button", { className: "nav-link text-white btn p-2 border-0", style: navLinkStyle("my-tickets"), onClick: () => onNavigate?.("my-tickets"), "data-testid": "nav-my-tickets", "aria-current": activePage === "my-tickets" ? "page" : undefined, children: "My Tickets" }) }), _jsx("li", { className: "nav-item", children: _jsx("button", { className: "nav-link text-white btn p-2 border-0", style: navLinkStyle("create-ticket"), onClick: () => onNavigate?.("create-ticket"), "data-testid": "nav-create-ticket", "aria-current": activePage === "create-ticket" ? "page" : undefined, children: "+ Create Ticket" }) })] })) }), user && (_jsxs("div", { className: "d-flex align-items-center gap-2", "data-testid": "authenticated-user-display", children: [_jsxs("span", { className: "text-white", style: { fontSize: "0.9rem" }, children: ["\uD83D\uDC64 ", user.name] }), _jsx("span", { style: {
